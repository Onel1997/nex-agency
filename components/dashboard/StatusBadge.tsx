...
const STATUS_STYLES: Record<LeadStatus, string> = {
  ...
  qualified: "bg-blue-500/15 text-blue-300 ring-blue-500/25",
  proposal: "bg-amber-500/15 text-amber-300 ring-amber-500/25",
  won: "bg-emerald-500/15 text-emerald-300 ring-emerald-500/25",
