import { VendorPayoutsPageClient } from "@/components/dashboard/VendorPayoutsPageClient";
  ...
  try {
    ...
    error =
      err instanceof Error
        ? err.message
        : "Vendor-Auszahlungen konnten nicht geladen werden";
  }
