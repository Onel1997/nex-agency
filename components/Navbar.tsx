    ...
    >
      <nav
        className={`mx-auto flex max-w-6xl items-center justify-between rounded-2xl border px-5 py-3 transition-all duration-300 ${
          scrolled
            ? "border-border-strong bg-surface/90 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.5)] backdrop-blur-xl"
            : "border-border/50 bg-surface/50 backdrop-blur-md"
        }`}
      >
      ...
      {open && (
        <motion.div
          ...
          className="mx-auto mt-2 max-w-6xl rounded-2xl border border-border bg-surface/95 p-4 backdrop-blur-xl md:hidden"
        >
